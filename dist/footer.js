"use strict";
function createLink(name, linkPath, elemType) {
...
if (footerTop) {
    footerTop.appendChild(createLink("goto top", "#", "h1"));
}
;
if (footerExplore) {
...
;
if (footerSupport) {
    footerSupport.appendChild(createLink("contact", "./contact.html", "p"));
}
;
if (footerOther) {
    footerOther.appendChild(createLink("about me", "./aboutme.html", "p"));
}
;
